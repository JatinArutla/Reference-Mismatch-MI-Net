...
# ---- Known-bad-subject filter -----------------------------------------------

def test_resolve_dataset_excludes_openbmi_subject_29():
    """OpenBMI subject 29 has a corrupt .mat in the GigaDB release; the
    default subject_list returned by _resolve_dataset must omit it so users
    don't accidentally hit it via subjects=None."""
