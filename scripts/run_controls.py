...
from refshift.experiments.controls import run_controls


def main():
    p = argparse.ArgumentParser()
    p.add_argument('--dataset', default='iv2a', choices=['iv2a','openbmi','cho2017','dreyer2023'])
    ...
    run_controls(Path(args.repo_root), args.dataset, args.cache_root, args.out_dir, cfg, subjects=subjects)
